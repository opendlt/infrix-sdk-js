...
test('ACTION_IDS matches the Go registry fixture (no drift)', () => {
  ...
  assert.equal(ACTION_IDS.length, 76, 'nextux-01 + nextux-02 + nextux-05 + nextux-06 + nextux-07 + nextux-08 + nextux-09 + nextux-10 + nextux-11 + nextux-12 + nextux-13 + nextux-14 + nextux-15 actions');
});
